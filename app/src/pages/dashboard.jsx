          ...
          <div className="row">
            ...
            <article className="best-post">
              ...
              <div className="best-post-content">
                <div className="best-post-content-cat">September 12, 2023<span className="dot"> </span>Blog</div>
                <div className="best-post-content-title">
                What is Helius
                </div>
                <div className="best-post-content-sub">
                Helius is a Solana infrastructure startup that provides developers with APIs, webhooks, and RPCs to make it easier to build applications on Solana. It was founded in 2022 by Mert Mumtaz, Vishant Agarwal, and Nikhil Acharya Prakash
                </div>
              </div>
            </article>
                    ...
                    <div className="post__card_-2">
                      ...
                      <div>
                        <div className="post__card_meta-2">
                          <div className="post__card_cat">September 12, 2023<span className="dot"> </span>{item.account.title} </div>
